...
5. Reassign pods as necessary to remove some edge conflicts as follows.
   1. If there is a pair of pods scheduled to move through an edge in excess of its capacity in opposite directions
   and swapping their assignments resolves the conflict, swap their assignments and repeat.
      1. Increase congestion counter on that edge.
