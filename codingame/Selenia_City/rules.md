...
3. Stage 1. Single pod approximation.
   1. Each pod makes an individual list of assignments, assuming no other pods exist.
      1. Assignments on the list are sorted as follows.
         ...
         3. Loads with larger total delivery time of all passengers at the origin, calculated as number of batches times delivery path length.
         This rule does not look at the actual boarding passengers, only on loads and their delivery paths.
