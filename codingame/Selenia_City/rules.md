...
5. Reassign pods as necessary to fix some of the edge conflicts. Specifically:
...
6. If a pod could not move because of an edge conflict on a particular day, its next movement is predetermined on subsequent days until he performs it.
